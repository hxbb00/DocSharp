...
public static class GdiConstants
{
    ...
    public const long BLACKNESS = 66;
    public const long DSTINVERT = 5570569;
    public const long MERGECOPY = 12583114;
    public const long MERGEPAINT = 12255782;
    public const long NOTSRCCOPY = 3342344;
    public const long NOTSRCERASE = 1114278;
    public const long PATCOPY = 15728673;
    public const long PATINVERT = 5898313;
    public const long PATPAINT = 16452105;
    public const long SRCAND = 8913094;
    public const long SRCCOPY = 13369376;
    public const long SRCERASE = 4457256;
    public const long SRCINVERT = 6684742;
    public const long SRCPAINT = 15597702;
    public const long WHITENESS = 16711778;
